...
- [Brownian motion의 정의](https://rouxist.github.io/posts/math_sc_part-2/#24-brownian-motion)에 따라 $T$ 시점에서 $$W_T \sim N(mT, \sigma^2 T)$$ 이다. 다만 보통은 Browian motion / Wiener Process를 정의할 때 $$m=0, \sigma^2=1$$ 로 하여 $$W_T \sim N(0, T)$$ 라고 [본다](https://en.wikipedia.org/wiki/Wiener_process#Characterisations_of_the_Wiener_process).
